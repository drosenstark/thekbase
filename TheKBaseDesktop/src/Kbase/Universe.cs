...
namespace Kbase 
{
	...
	internal class Universe 
	{
        ...
        public Properties.PropertiesPane propertiesPane;
        ...
        public void OnAfterSelect(List<Snippet> snippets) {
            CacheReset();
            detailPane.EditNone();
            propertiesPane.Edit(snippets);
        }

        public void OnAfterSelectNone()
        {
            CacheReset();
            propertiesPane.EditNone();
            detailPane.EditNone();
        }
        ...
        public void Exit() {
            ...
            // 
            // However I think this is now solved 2006-06-16 because I put the mainform
