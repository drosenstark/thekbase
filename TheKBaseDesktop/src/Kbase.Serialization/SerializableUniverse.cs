...
namespace Kbase.Serialization
{
	...
	public class SerializableUniverse
	{
		...
		public SerializableUniverse(IList theParents) : this(theParents, Serializer.GetDefaultSerializer())
		{
		...
		public void Restore(bool merge) {
			// not really implemented yet
			Restore(Universe.Instance.ModelGateway.TopLevelSnippet, merge);
		}
        ...
        void RestoreProperties() {
            ...
            foreach (int id in propertyIds) {
                ...
                if (property != null)
                    Universe.Instance.propertiesPane.RegisterProperty(property);
            }
            Universe.Instance.propertiesPane.OnAfterRestoreProperties();
        }
